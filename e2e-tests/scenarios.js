...
var PhoneList = (function () {
    var query = element(by.model('$ctrl.query')),
        ...
        phoneNameColumn = element.all(by.repeater('phone in $ctrl.phones').column('phone.name')),
        phoneLinks = element.all(by.css('.phones li a'));

    function sortBy(property) {
        return element(by.model('$ctrl.orderProp')).element(by.css('option[value="' + property + '"]')).click();
    }
...
var Nexus = (function () {
    var name = element(by.binding('$ctrl.phone.name')),
        selected = element(by.css('img.phone.selected'));
    ...
    return {
        ...
        currentImage: function () {
            return selected.getAttribute('src');
        },
